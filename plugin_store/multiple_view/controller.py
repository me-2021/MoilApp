...
class UiController(Ui_MainWindow):
    ...
    def show_to_window(self):
        ...
        if self.normal_view:
            ...
            MoilUtils.show_image_to_label(self.label_image4, image_4, self.width_result_multi)
            image_5 = cv2.remap(self.image.copy(), self.mapX_5, self.mapY_5, cv2.INTER_CUBIC)
            MoilUtils.show_image_to_label(self.label_image5, image_5, self.width_result_multi)
            image_6 = cv2.remap(self.image.copy(), self.mapX_6, self.mapY_6, cv2.INTER_CUBIC)
            MoilUtils.show_image_to_label(self.label_image6, image_6, self.width_result_multi)
