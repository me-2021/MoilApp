...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icon/setup_parameter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius: 10px;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/Load_image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon/setup_parameter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
